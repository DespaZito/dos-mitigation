...
1. SSH to your XDC
2. `cd /usr/local`
3. Run `sudo -E git clone https://github.com/DespaZito/dos-mitigation.git` to clone this repository.  You'll need sudo to write in `/usr/local`, and the `-E` flag will preserve your environment variables with sudo (including SSH keys). To run a branch of this repository, run `sudo -E git clone branchNameHere --single-branch https://github.com/DespaZito/dos-mitigation.git` instead.
